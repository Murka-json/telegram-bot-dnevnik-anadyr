...
module.exports = async (username, password) => {
    return new Promise(async (resolve, reject) => {
        ...
        await page.goto(
            'https://sosh1.dnevnik.anadyrobr.ru/',
            {
        ...
        await page
            .type('#main_info > form > p:nth-child(4) > input', `${username}`)
            .catch(err => reject(`Неправильно введены данные. Пожалуйста, выйдите из профиля и войдите снова с правильными данными.`))
        await page
            .type('#main_info > form > p:nth-child(6) > input', `${password}`)
            .catch(err => reject(`Неправильно введены данные. Пожалуйста, выйдите из профиля и войдите снова с правильными данными.`))
        ...
        await page
            .click("#panel_center > a:nth-child(4) > img")
            .catch(() => reject(`Ошибка на стороне электронного дневника. Пожалуйста, попробуйте снова...`))

        await new Promise(r => setTimeout(r, 10000))

        await page.click("#show_average")
